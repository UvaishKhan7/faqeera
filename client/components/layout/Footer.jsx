    ...
    <footer className="w-full bg-black">
      <div className="w-full mx-auto px-4 py-12 flex flex-col items-center justify-center">
        <div className="max-w-full lg:m-auto grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-6">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            <Link href="/" className="inline-block mb-4">
              <Image src="/BLVKC.svg" width={120} height={50} alt="Faqeera Logo" priority />
            </Link>
          ...
          <div className="lg:mx-auto">
            <h3 className="font-semibold text-gray-400 mb-4">Shop</h3>
          ...
          {/* Column 3: About */}
          <div className="lg:mx-auto">
            <h3 className="font-semibold text-white mb-4">About Faqeera</h3>
        ...
        <div className="border-t mt-8 pt-6 text-center text-sm text-muted-foreground">
          <p>© {new Date().getFullYear()} BLVKC. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
